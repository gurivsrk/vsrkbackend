              ...
              <td style="direction: ltr;font-size: 0px;padding: 0px;text-align: center;vertical-align: top;border-collapse: collapse;">
                ...
                <div style="margin:0px auto;max-width:600px; background:linear-gradient(#38a9dd, #38a9dd)">
                  <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;border-collapse: collapse;">
                    <tbody>
                      <tr>
                        <td style="direction: ltr;font-size: 0px;padding: 30px 30px 10px 30px;text-align: center;vertical-align: top;border-collapse: collapse;">
                                        ...
                                        <td align="center" style="font-size: 0px;padding: 0;border-collapse: collapse;">
                                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                            <tbody>
                                              ...
                                              <tr>
                                                <td style="width: 600px;border-collapse: collapse;"> <img src="{{ asset('frontend/imgs/email/haveaniceday-min.png') }}" style="border: 0;display: block;outline: none;text-decoration: none;height: auto;width: 190px;position: relative;margin-left: auto;margin-right: auto;line-height: 100%;" width="600" alt="header">
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
