@extends('layouts.frontend.frontend', ['activeClass' => 'investment','pageType'=>'mutual_funds'])
            ...
            <div class="container">
                <div class="page-title-content">
                    ...
                    <ul>
                        ...
                        <li class="item"><a href="javascript:void(0)">Mutual Funds Investments</a></li>
                    </ul>
                </div>
            </div>
            <div class="shape">
