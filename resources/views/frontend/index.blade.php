...
@section('frontend_content')
        ...
        <section class="graph-section ptb-100">
            <div class="container">
                ...
                <div id="calC">
                    @include('partials.frontend.calculator',['calc_type'=>@$home->calc_type,'content'=>@$home])
                </div>
            </div>
        </section>
        <!-- end graph section -->
